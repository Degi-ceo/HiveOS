...
preserve old history. `/approve` and `/deny` are deliberately not exposed until they
reuse the existing fail-closed approval decision path. See `docs/TELEGRAM_COMMANDS.md`.
