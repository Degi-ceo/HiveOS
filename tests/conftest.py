...
_DOTENV_VARS = ("HIVE_SECRET", "HIVE_PRODUCTION", "HIVE_HOST", "HIVE_PORT", "HIVE_DATA_DIR", "HIVE_STATE_DB",
                ...
                "HIVE_AUDIT_INTEGRITY_BOOTSTRAP",
                "HIVE_CORS_ORIGINS", "HIVE_CORS_ALLOW_WILDCARD",
                "HIVE_HTTP_RATE_LIMIT", "HIVE_WS_RATE_LIMIT",
                "HIVE_RATE_LIMIT_WINDOW", "HIVE_WS_HANDSHAKE_TIMEOUT",
                "HIVE_MCP_SERVERS", "HIVE_MCP_SERVER_PINS",
